...
pulstmcnn = PULSTMCNN(dp, charcnn, wordnet, casenet, 138, 200, 1, 0.5)
...
if args.output:
    outputFile = "result/no_feature_pu_" + args.dataset + "_"+ args.flag + "_" + str(args.set) + ".txt"
